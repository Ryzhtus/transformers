...
class RobertaFlashAttention2(RobertaAttention):
    """
    XLMRoberta flash attention module. This module inherits from `RobertaAttention` as the weights of the module
...
class RobertaLayer(nn.Module):
    def __init__(self, config):
        ...
        if self.add_cross_attention:
            ...
            self.crossattention = ROBERTA_ATTENTION_CLASSES[config._attn_implementation](
                config, position_embedding_type="absolute"
            )
